...
<body>
	...
	<div class="container-fluid my-5">
		<div class="row mb-4">
			<h1 class="col-md-7 mx-auto text-center border-bottom border-dark-pb-3">글 목록</h1>
		</div>
	...
	<div class="row col-md-7 mx-auto">
		<table class="table table-hover">
			...
			<c:forEach items="${list}" var="dto">
				<tr>
					<td><a href="../board/detail?num=${dto.num}">${pageScope.dto.title}</a></td>
					<td class="tbl_td">${pageScope.dto.writer}</td>
					<td class="tbl_td">${pageScope.dto.regDate}</td>
					<td class="tbl_td">${pageScope.dto.hit}</td>
				</tr>
			</c:forEach>
			</tbody>
		</table>
